...
$content .=' <div class="caption"><p>'.$color[$key].' '.substr($sequence_noArray[$key],0,-12).str_repeat("X",10).'</p>';

$content .='<div class="thumbnail"> <img src="'.$value.'" alt="Lights" style="width:40%">';
$content .='<div  class="caption">'.$hcf_numberArray[$key].'</div>';
$content .='</div>';
$content .='</div>';
$content .='</div>';
$content .='</div>';
