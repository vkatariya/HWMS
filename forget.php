					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 to_animate">
							<div class="with_border with_padding">
								...
								//if(isset($_SESSION['failed'])) { echo $failed; } ?>
									...
									<form action="loginVerify.php" method="post">										<div class="row">
											...
											<div class="col-sm-12">
												<div class="form-group has-placeholder">
													...
													<input type="email" class="form-control" id="login-email" name="email" placeholder="Email/UserID">
												</div>
										...
										<button type="submit" name="update_password" value="Update Password"   class="theme_button block_button color2">Update Password</button>
